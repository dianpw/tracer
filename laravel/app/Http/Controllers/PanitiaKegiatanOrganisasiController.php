...
class PanitiaKegiatanOrganisasiController extends Controller
{
    public function index()
    {
        ...
        return view('panitia_kegiatan_organisasi.index', compact('auth_user', 'show_tahun', 'tahun_terakhir'));
    }
    ...
    public function show_data(){
        try {
            ...
            if(Auth::user()->role_id == 1){
                $query = DB::table('tb_berwirausaha')
                ->Leftjoin('tb_mahasiswa', 'tb_berwirausaha.npm',  'tb_mahasiswa.npm')
    ...
    public function exportExcel(){
        ...
        $sheet->setCellValue('B2', 'LAPORAN TRACER STUDY - MAHASISWA BERWIRAUSAHA');
        ...
        $sheet->setCellValue('G3', 'TINGKAT TEMPAT KERJA');
        ...
        foreach ($query as $key => $value) {
            ...
            $sheet->setCellValue('F'.$i, $value->posisi);
            $sheet->setCellValue('G'.$i, $value->tingkat);
        ...
        $date = date('d-F-Y');
        $file_name = 'Laporan Alumni Berwirausaha - '. $date.'.xlsx';
