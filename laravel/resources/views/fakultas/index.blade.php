        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                    <div class="row">
                        <div class="col-md-12"><h5><i class="m-menu__link-icon flaticon-user"></i> Data Fakultas</h5></div>
    ...
    <div class="modal-dialog modal-lg opacity-animate2" style="max-width: 40%;overflow-y: initial !important">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                <h6 class="modal-title" style="color: whitesmoke;height:5px;padding-bottom:7px;margin-top:-10px"><b><i class="m-menu__link-icon flaticon-user"></i> Buat Fakultas</b></h6>
            ...
            overflow-y: auto;">
                ...
                <b style="color: red">*Form Fakultas</b>
                <hr>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                <label for="Name">* Fakultas:</label><br>
    ...
    <div class="modal-dialog modal-lg opacity-animate2" style="max-width: 40%;overflow-y: initial !important">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color: #4f7f4f;color:white">
                <h6 class="modal-title" style="color: whitesmoke;height:5px;padding-bottom:7px;margin-top:-10px"><b><i class="m-menu__link-icon flaticon-user"></i> Update Fakultas</b></h6>
                <button type="button" class="close" style="color: whitesmoke" data-dismiss="modal">&times;</button>
            </div>
            <!-- Modal body -->
            <div class="modal-body" style="height: 220px;
            overflow-y: auto;">
                ...
                <b style="color: red">*Form Ubah Fakultas</b>
                <hr>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                       <input required type="text" id="txtedit_fakultas" class="form-control" placeholder="Fakultas.." name="fakultas">
...
<script>
    ...
    $(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response) {
                        ...
                        Swal.fire({
                            title: 'Information',
                            html: 'Fakultas berhasil disimpan',
                            type: 'success',
                ...
                success: function (response) {
                    ...
                    if(response.status == 'success') {
                       if(response.result != null){
                           ...
                           $('#txtedit_fakultas').val(data.fakultas);
        ...
        function delete_master(url, data) {
            swal.fire({
                title: "Informasi !",
                text: "Apakah anda ingin menghapus Fakultas ?",
                type: "warning",
                showCancelButton: true,
                confirmButtonText: 'Ya, Hapus Fakultas!'
            }).then((result) => {
                if(result.value)
                {
                    $.ajax({
