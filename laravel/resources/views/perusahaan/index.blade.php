...
<body style="background-image: public/images/logounisma.png"
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="form-group row">
                                                <div class="col-lg-12 text-center">
                                                    <img src="public/UserSurvei.jpg" class="img-fluid" alt="Surat Edaran User Survey">                                                    
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    <label>Nama Lengkap   &nbsp<b style="color:red">*).required</b></label>
                                                    <input type="text" name="nama" required placeholder="Jawaban Anda"
                                                        class="form-control m-input">
                                                    <span class="m-form__help">&nbsp</span>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="">Jabatan  &nbsp<b style="color:red">*).required</b></label>
                                                    <input type="text" class="form-control m-input" name="jabatan"
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Alamat Perusahaan / kantor  &nbsp<b style="color:red">*).required</b></b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="text" placeholder="Jawaban Anda" required
                                                            name="alamat_perusahaan" class="form-control">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light"
                                                            id="reset_alamat_perusahaan" type="button"><b>Clear
                                                                Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Nomor Telp Perusahaan / kantor  &nbsp<b style="color:red">*).required</b></b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="text" placeholder="Jawaban Anda" required
                                                            name="no_tel_kantor" class="form-control">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light"
                                                            id="reset_no_tel_kantor" type="button"><b>Clear
                                                                Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Berapakah jumlah lulusan Universitas Islam Malang yang bekerja di
                                                perusahaan Anda ?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">

                                                        <input type="number" placeholder="Jawaban Anda"
                                                            name="jumlah_lulusan" class="form-control">

                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light"
                                                            id="reset_jumlah_lulusan" type="button"><b>Clear
                                                                Selection</b>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Berapakah rata-rata masa kerja lulusan Universitas Islam Malang yang
                                                bekerja di perusahaan Anda (dalam tahun) ?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="number" placeholder="Jawaban Anda"
                                                            name="masa_kerja" class="form-control">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_masa_kerja"
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Berapakah gaji/pendapatan awal yang diterima lulusan Universitas Islam
                                                Malang di perusahaan Anda (dalam jutaan rupiah) ?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="number" placeholder="Jawaban Anda" name="gaji_awal"
                                                            class="form-control">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_gaji_awal"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Berapakah nilai IPK (skala Kurang) minimal untuk bekerja di perusahaan
                                                Anda ?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="text" placeholder="Jawaban Anda" name="ipk"
                                                            class="form-control">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_ipk"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Tingkat Kepuasan Pengguna Lulusan (sebagai atasan terhadap alumni yang
                                                bekerja di perusahaan anda)</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                                                        <table class="table table-striped m-table"
                                                            ...
                                                            <tbody>
                                                                        ...
                                                                        <div class="form-check">
                                                                            ...
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    required type="radio" name="etika"
                                                                                    id="etika1" value="Sangat Baik">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="etika2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="etika"
                                                                                    id="etika2" value="Baik">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Keahlian Berdasarkan
                                                                        Bidang Ilmu</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="keahlian2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="keahlian"
                                                                                    id="keahlian2" value="Baik">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="bahasa_inggris"
                                                                                    id="bahasa_inggris3" value="Cukup">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="bahasa_inggris"
                                                                                    id="bahasa_inggris4" value="Kurang">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Penggunaan Teknologi
                                                                        Informasi</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="penggunaan_ti"
                                                                                    id="penggunaan_ti4" value="Kurang">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                    ...
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light"
                                                            id="reset_kepuasan_pengguna" type="button"><b>Clear
                                                                Selection</b>
                                                        </button>
                                                    </div>
                                                    <br>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apakah nilai soft skill yang Anda inginkan dari lulusan Unisma Malang ?
                                                </br>Ket: <i>Soft skill adalah nilai kepribadian serta kemampuan
                                                    seseorang dalam berinteraksi dengan sesama dan dengan
                                                    lingkungan</i></b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                                                        <table class="table table-striped m-table"
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="percara_diri2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="percara_diri"
                                                                                    id="percara_diri2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="kejujuran2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="kejujuran"
                                                                                    id="kejujuran2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="kedisiplinan2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="kedisiplinan"
                                                                                    id="kedisiplinan2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    required type="radio"
                                                                                    name="komunikasi" id="komunikasi1"
                                                                                    value="1">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="motivasi2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="motivasi"
                                                                                    id="motivasi2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Mudah adaptasi &
                                                                        bekerjasama</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="adaptasi2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="adaptasi"
                                                                                    id="adaptasi2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Mampu bekerja dalam
                                                                        tekanan</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="tekanan1">
                                                                                <input class="form-check-input"
                                                                                    required type="radio" name="tekanan"
                                                                                    id="tekanan1" value="1">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                    ...
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_soft_skill"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                    <br>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Selain nilai soft skill, kriteria apakah yang Anda inginkan dari lulusan
                                                Unisma Malang ?</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                                                        <table class="table table-striped m-table"
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="krit_ipk2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="krit_ipk"
                                                                                    id="krit_ipk2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Kemampuan Bahasa asing
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="bahasa_asing2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="bahasa_asing"
                                                                                    id="bahasa_asing2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="komputer2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="komputer"
                                                                                    id="komputer2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Jumlah penghargaan yang
                                                                        diterima</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    required type="radio"
                                                                                    name="penghargaan" id="penghargaan1"
                                                                                    value="1">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="penghargaan2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="penghargaan"
                                                                                    id="penghargaan2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Lama pengalaman kerja
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    required type="radio"
                                                                                    name="pengalaman" id="pengalaman1"
                                                                                    value="1">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="pengalaman2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="pengalaman"
                                                                                    id="pengalaman2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Jumlah pelatihan yang
                                                                        pernah diikuti</td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="pelatihan2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="pelatihan"
                                                                                    id="pelatihan2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                                ...
                                                                <tr class="text-center">
                                                                    <td class="text-left">Kemampuan mengendarai
                                                                    </td>
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    required type="radio"
                                                                                    name="berkendara" id="berkendara1"
                                                                                    value="1">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    ...
                                                                    <td>
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                for="berkendara2">
                                                                                <input class="form-check-input"
                                                                                    type="radio" name="berkendara"
                                                                                    id="berkendara2" value="2">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                                    ...
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_kriteria"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                    <br>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                                ...
                                <div class="m-portlet__body" style="margin-top: -40px">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Masukan apakah yang ingin Anda sampaikan kepada Unisma Malang untuk
                                                peningkatan mutu lulusan ?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <textarea class="form-control" placeholder="Jawaban Anda"
                                                            id="masukan" name="masukan" rows="4"></textarea>
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_masukan"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                        ...
                                                        <div class="m-form__actions m-form__actions--solid"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6 m--align-right">
                                                                    ...
                                                                    <button type="submit"
                                                                        class="btn btn-success">Submit Tracer</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script src="public/vendors/js/framework/components/plugins/forms/bootstrap-datepicker.init.js" type="text/javascript">
    </script>
    ...
    <script src="public/vendors/js/framework/components/plugins/forms/bootstrap-timepicker.init.js" type="text/javascript">
    </script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('.berikutnya').click(function() {
                if ($('input[name ="jabatan"]').val() == '' || $('input[name ="nama"]').val() == '' || $(
                        'input[name ="email"]').val() == '' || $('input[name ="jeniskelamin"]').value ==
