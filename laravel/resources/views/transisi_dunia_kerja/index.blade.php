        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <div id="chart_transisi_dunia_kerja"></div>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="m-alert m-alert--icon m-alert--air alert alert-dismissible fade show" role="alert" style="background-color: #95a57e36">
                            ...
                            <div class="m-alert__text">
                                ...
                                - Apakah Anda sudah mempunyai pekerjaan saat lulus S2/S3 UNISMA?</br>	
                                - Apakah Anda pindah ke pekerjaan baru setelah lulus S2/S3 UNISMA?
                            </div>
                           
                        </div>
                    </div>
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_transisi_dunia_kerja')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
                ...
                <table cellpadding="0" class="table-striped tabel_show table table-bordered nowrap" cellspacing="0" width="100%">
                    <thead style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                        <tr>
                            ...
                            <th>BEKERJA SAAT LULUS</th>
                            <th>PINDAH KERJA SETELAH LULUS</th>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-transisi-dunia-kerja")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-transisi-dunia-kerja')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){
                console.log(response);
                Highcharts.chart('chart_transisi_dunia_kerja', {
                    chart: {
                        type: 'bar'
                    },
                    title: {
                        text: 'Transisi ke Dunia Kerja - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                    },
                    subtitle: {
                        text: 'Source: <a href="">http://cdc.unisma.ac.id/tracer_study/</a>'
                    },
                    xAxis: {
                        categories: ['Sudah mempunyai pekerjaan saat lulus',
                                    'Belum mempunyai pekerjaan saat lulus',
                                    'Pindah ke pekerjaan baru setelah lulus',
                                    'Tetap bekerja di pekerjaan terdahulu',
                                    ],
                        title: {
                            text: null
                        }
                    ...
                    series: [{
                        data: [
                            {y:response.yasudah_kerja[0], color:'#0074D9'},
                            {y:response.tidaksudah_kerja[0], color:'#39CCCC'},
                            {y:response.yapindah_kerja[0], color:'#B10DC9'},
                            {y:response.tidakpindah_kerja[0], color:'#AAAAAA'},
                        ],
                        showInLegend: true
                    }]
                });
