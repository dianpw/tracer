								...
								<div class="m-stack__item m-stack__item--middle m-brand__tools" >
								   ...
								   $str= $str_nama[0];
									...
									<a id="click_alumni2" style="color: white" id="m_aside_header_topbar_mobile_toggle" href="javascript:;" class="m-brand__icon m--visible-tablet-and-mobile-inline-block">
										<div style="margin-bottom:11px;"><b><i class="la la-user"></i> </b> Alumni S3,</div><br><br><br>
										<b >{{$str}}</b>
									</a>
									<!-- BEGIN: Topbar Toggler -->
								</div>
						...
						<div class="m-stack__item m-stack__item--fluid m-header-head" style="background-color: #3d8a49" id="m_header_nav">
							...
							<div id="m_header_topbar" class="m-topbar  m-stack m-stack--ver m-stack--general m-stack--fluid" >
								<div class="m-stack__item m-topbar__nav-wrapper" style="margin-top:-150px">
                                    ...
                                    <b style="color:whitesmoke"><i class="la la-user"></i> Alumni S3, {{$data_mhs->npm .' | '.$data_mhs->nama}}</b> <b style="color: gray"></b>
                                    </a>
                        ...
                        <div class="isi_quisioner fade-in"><!---->
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apa nama Perguruan Tinggi terakhir sebelum menempuh pendidikan di S3 UNISMA?<b style="color:red">*).required</b>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apa Program Studi yang Anda ambil sebelum menempuh pendidikan di S3 UNISMA?<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">                                
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apakah Anda bekerja sebelum kuliah di S3 UNISMA?<b style="color:red">*).required</b>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="riwayat_kerja1">
                                                            <input type="radio" name="riwayat_kerja" id="riwayat_kerja1" value="Ya, bekerja tapi berhenti saat masuk kuliah di program S3 UNISMA">
                                                            Ya, bekerja tapi berhenti saat masuk kuliah di program S3 UNISMA
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                ...
                                <div class="m-portlet__body" style="margin-top: -40px">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apakah pendidikan yang diambil di S3 Unisma sesuai dengan latar belakang pendidikan Anda?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                ...
                                <div class="m-portlet__body" style="margin-top: -40px">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apakah pendidikan yang diambil di S3 Unisma sesuai dengan bidang pekerjaan Anda saat ini?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Bagaimana Anda mencari/mendapatkan pekerjaan setelah lulus S3 UNISMA? (<i>jawaban boleh lebih dari satu</i>)</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Berapa nominal kenaikan pendapatan rata-rata Anda setelah mengambil S3 UNISMA?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bawah ini yang Anda kuasai? (A)</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bwah ini diperlukan dalam pekerjaan? (B)</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                        ...
                                        <div class="m-portlet__body">
                                            <b>Seberapa besar peran kompetensi yang diperoleh di S3 UNISMA berikut ini dalam melaksanakan pekerjaan
