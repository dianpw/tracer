                        ...
                        <div class="m-stack m-stack--ver m-stack--general">
                            ...
                            <div class="m-stack__item m-stack__item--middle m-brand__tools">
                                ...
                                <a id="click_alumni2" style="color: white" id="m_aside_header_topbar_mobile_toggle"
                                    ...
                                    <div style="margin-bottom:11px;"><b><i class="la la-user"></i> </b> Alumni S2,
                                    </div><br><br><br>
                                    <b>{{ $str }}</b>
                                </a>
                                <!-- BEGIN: Topbar Toggler -->
                        ...
                        <div id="m_header_topbar"
                            ...
                            <div class="m-stack__item m-topbar__nav-wrapper" style="margin-top:-150px">
                                <a id="click_alumni" href="javascript:;">
                                    <b style="color:whitesmoke"><i class="la la-user"></i> Alumni S2,
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apa nama Perguruan Tinggi terakhir sebelum menempuh pendidikan di S2
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apa Program Studi yang Anda ambil sebelum menempuh pendidikan di S2 UNISMA?<b
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah Anda bekerja sebelum kuliah di S2 UNISMA?<b
                                                style="color:red">*).required</b>
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success"
                                                            ...
                                                            <input type="radio" name="riwayat_kerja" id="riwayat_kerja1"
                                                                value="Ya, bekerja tapi berhenti saat masuk kuliah di program S2 UNISMA">
                                                            Ya, bekerja tapi berhenti saat masuk kuliah di program S2
                                                            UNISMA
                                                            <span></span>
                                                        </label>
                                                    </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah pendidikan yang diambil di S2 Unisma sesuai dengan latar belakang
                                            pendidikan Anda?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah pendidikan yang diambil di S2 Unisma sesuai dengan bidang pekerjaan
                                            Anda saat ini?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Bagaimana Anda mencari/mendapatkan pekerjaan setelah lulus S2
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Berapa nominal kenaikan pendapatan rata-rata Anda setelah mengambil S2
                                        UNISMA?</b>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="input-group mb-6">
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Pada saat lulus S2 UNISMA, pada tingkat mana kompetensi di bawah ini yang Anda
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Pada saat lulus S2 UNISMA, pada tingkat mana kompetensi di bwah ini diperlukan
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Seberapa besar peran kompetensi yang diperoleh di S2 UNISMA berikut ini dalam
