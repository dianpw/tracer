                        ...
                        <div class="isi_quisioner fade-in"><!---->
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">                                
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F12. Sebutkan sumberdana dalam pembiayaan kuliah?</b>&nbsp<b style="color:red">*).required</b>
                                ...
                                <div class="m-portlet__head">
                                    <div class="m-portlet__head-caption">
                                        <div class="m-portlet__head-title">
                                            ...
                                            <h3 class="m-portlet__head-text">Lewati Section Ini Jika Anda Tidak Mencari Kerja</h3>
                                            <h2 class="m-portlet__head-label m-portlet__head-label--success">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F4. Bagaimana cara Anda mendapatkan pekerjaan setelah lulus dari program pascasarjana UNISMA? (<i>jawaban boleh lebih dari satu</i>)</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F6. Berapa perusahaan/instansi/institusi yang sudah anda lamar (lewat surat atau e-mail) sebelum anda memeroleh pekerjaan pertama?  </b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F7. Berapa banyak perusahaan/instansi/institusi yang merespons lamaran anda? </b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F7a. Berapa banyak perusahaan/instansi/institusi yang mengundang anda untuk wawancara? </b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F9. Bagaimana anda menggambarkan situasi anda saat ini? </b>(<i>Jawaban bisa lebih dari satu</i>)
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F5. Berapa bulan waktu yang dibutuhkan (sebelum dan sesudah kelulusan Anda) untuk mendapatkan pekerjaan pertama?</b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <table >
                                                        <tr >
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F10. Apakah anda aktif mencari pekerjaan dalam 4 minggu terakhir?</b>(<i>Pilihlah Satu Jawaban.</i>)
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="status_kerja1">
                                                            <input type="radio" name="status_kerja" id="status_kerja1" value="Bekerja (Fultime / Parttime)">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="status_kerja2">
                                                            <input type="radio" name="status_kerja" id="status_kerja2" value="Wirausaha">
                                                            Wirausaha
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="status_kerja3">
                                                            <input type="radio" name="status_kerja" id="status_kerja3" value="Melanjutkan pendidikan">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="status_kerja4">
                                                            <input type="radio" name="status_kerja" id="status_kerja4" value="Tidak kerja tetapi sedang mencari kerja">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="status_kerja5">
                                                            <input type="radio" name="status_kerja" id="status_kerja5" value="Belum memungkinkan bekerja">
                                    ...
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan1">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan1" value="Instansi Pemerintahan">
                                                            Instansi Pemerintahan
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan2">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan2" value="BUMN/BUMD">
                                                            BUMN/BUMD
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan3">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan3" value="Institusi/Organisasi Multilateral">
                                                            Institusi/Organisasi Multilateral
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan4">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan4" value="Oragnisasi Non-profit/Lembaga Swadaya Masyarakat">
                                                            Oragnisasi Non-profit/Lembaga Swadaya Masyarakat
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan5">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan5" value="Perusahaan Swasta">
                                                            Perusahaan Swasta
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan6">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan6" value="Wiraswasta/Perusahaan Sendiri">
                                                            Wiraswasta/Perusahaan Sendiri
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="jenis_perusahaan7">
                                                            <input type="radio" name="jenis_perusahaan" id="jenis_perusahaan7" value="Lainnya…">
                                                            Lainnya…
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_jenis_perusahaan" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F14. Seberapa erat hubungan antara bidang studi dengan pekerjaan anda?</b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>E3. Tingkat pendidikan apa yang paling tepat/sesuai untuk pekerjaan anda saat ini?</b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                ...
                                <div class="m-portlet__head">
                                    <div class="m-portlet__head-caption">
                                        <div class="m-portlet__head-title">
                                            ...
                                            <h3 class="m-portlet__head-text">Lewati bagian ini jika Anda tidak berwirausaha</h3>
                                            <h2 class="m-portlet__head-label m-portlet__head-label--success">
                                                <span>Wirausaha</span>
                                            </h2>
                                        </div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="posisi4">
                                                            <input type="radio" name="posisi" id="posisi4" value="Freelance/Kerja Lepas">
                                                            Freelance/Kerja Lepas
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_posisi" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="tingkat1">
                                                            <input type="radio" name="tingkat" id="tingkat1" value="Lokal/wilayah/wirausaha tidak berbadan hukum">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="tingkat2">
                                                            <input type="radio" name="tingkat" id="tingkat2" value="Nasional/wiraswasta berbadan hukum">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="tingkat3">
                                                            <input type="radio" name="tingkat" id="tingkat3" value="Multinasional/internasional">
                                                            Multinasional/internasional
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_tingkat" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="m-portlet__head">
                                    <div class="m-portlet__head-caption">
                                        <div class="m-portlet__head-title">
                                            ...
                                            <h3 class="m-portlet__head-text">Lewati bagian ini jika Anda tidak sedang Studi Lanjut</h3>
                                            <h2 class="m-portlet__head-label m-portlet__head-label--success">
                                                    ...
                                                    <table class="col-lg-12" >
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="m-radio-inline">
                                                                    <label class="m-radio m-radio--solid">
                                                                        <input type="radio" name="biaya" id="biaya" value="Biaya Sendiri"> Biaya Sendiri
                                                                        <span></span>
                                                                    </label>
                                                                    <label class="m-radio m-radio--solid">
                                                                        <input type="radio" name="biaya" id="biaya" value="Beasiswa"> Beasiswa
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" placeholder="Jawaban anda.." name="universitas" class="form-control" >
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group mb-3">
                                                                    <input type="text" placeholder="Jawaban anda.." name="prodi" class="form-control" >
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="input-group mb-3">
                                                                    <input id="masuk_study" type="text" class="form-control m-input" name="masuk_study" placeholder="Jawaban anda..">
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_lanjut_study" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>F4. Jika menurut anda pekerjaan anda saat ini tidak sesuai dengan pendidikan anda, mengapa anda mengambilnya? </b>(<i> Jawaban bisa lebih dari satu</i>)
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Pada saat lulus, pada tingkat mana kompetensi di bawah ini Anda kuasai? (A)</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Pada saat lulus, bagaimanan kontribusi UNISMA dalam kompetensi di bawah ini? (B)</b>&nbsp<b style="color:red">*).required</b>
                                            <br><br>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                <div class="m-portlet__body">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Menurut Anda, bagaimanakah profil karakter kepribadian Anda dalam lingkungan kerja?</b>&nbsp<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="table-demontrasive">
                                                    <table class="table table-striped m-table" style="display: block; min-height: 300px; overflow-x: auto;border:1">
                                                        ...
                                                        <tbody>
                                                        <tr class="text-center">
                                                                <td class="text-left">Melakukan pekerjaan dengan penuh tanggung jawab dan keikhlasan</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="tanggung_jawab1">
                                                                            <input class="form-check-input " required type="radio" name="tanggung_jawab" id="tanggung_jawab1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="tanggung_jawab2">
                                                                            <input class="form-check-input " type="radio" name="tanggung_jawab" id="tanggung_jawab2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="tanggung_jawab3">
                                                                            <input class="form-check-input " type="radio" name="tanggung_jawab" id="tanggung_jawab3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="tanggung_jawab4">
                                                                            <input class="form-check-input " type="radio" name="tanggung_jawab" id="tanggung_jawab4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="tanggung_jawab5">
                                                                            <input class="form-check-input " type="radio" name="tanggung_jawab" id="tanggung_jawab5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjasama1">
                                                                            <input class="form-check-input " type="radio" required name="bekerjasama" id="bekerjasama1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjasama2">
                                                                            <input class="form-check-input " type="radio"  name="bekerjasama" id="bekerjasama2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjasama3">
                                                                            <input class="form-check-input " type="radio" name="bekerjasama" id="bekerjasama3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjasama4">
                                                                            <input class="form-check-input " type="radio" name="bekerjasama" id="bekerjasama4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjasama5">
                                                                            <input class="form-check-input " type="radio" name="bekerjasama" id="bekerjasama5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Bersungguh-sungguh dan memegang teguh nilai kebenaran dalam melakanakan pekerjaan</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bersungguhsungguh1">
                                                                            <input class="form-check-input " required type="radio" name="bersungguhsungguh" id="bersungguhsungguh1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bersungguhsungguh2">
                                                                            <input class="form-check-input " type="radio" name="bersungguhsungguh" id="bersungguhsungguh2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bersungguhsungguh3">
                                                                            <input class="form-check-input " type="radio" name="bersungguhsungguh" id="bersungguhsungguh3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bersungguhsungguh4">
                                                                            <input class="form-check-input " type="radio" name="bersungguhsungguh" id="bersungguhsungguh4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bersungguhsungguh5">
                                                                            <input class="form-check-input " type="radio" name="bersungguhsungguh" id="bersungguhsungguh5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Bekerja keras sesuai dengan kompetensi</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjakeras1">
                                                                            <input class="form-check-input " required type="radio" name="bekerjakeras" id="bekerjakeras1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjakeras2">
                                                                            <input class="form-check-input " type="radio" name="bekerjakeras" id="bekerjakeras2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjakeras3">
                                                                            <input class="form-check-input " type="radio" name="bekerjakeras" id="bekerjakeras3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjakeras4">
                                                                            <input class="form-check-input " type="radio" name="bekerjakeras" id="bekerjakeras4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="bekerjakeras5">
                                                                            <input class="form-check-input " type="radio" name="bekerjakeras" id="bekerjakeras5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Toleran dan mampu menerima masukkan dari siapapun</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="toleran1">
                                                                            <input class="form-check-input " required type="radio" name="toleran" id="toleran1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="toleran2">
                                                                            <input class="form-check-input " type="radio" name="toleran" id="toleran2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="toleran3">
                                                                            <input class="form-check-input " type="radio" name="toleran" id="toleran3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="toleran4">
                                                                            <input class="form-check-input " type="radio" name="toleran" id="toleran4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="toleran5">
                                                                            <input class="form-check-input " type="radio" name="toleran" id="toleran5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Meletakkan segala sesuatu secara profesional</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="meletakkansegalasesuatu1">
                                                                            <input class="form-check-input " required type="radio" name="meletakkansegalasesuatu" id="meletakkansegalasesuatu1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="meletakkansegalasesuatu2">
                                                                            <input class="form-check-input " type="radio" name="meletakkansegalasesuatu" id="meletakkansegalasesuatu2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="meletakkansegalasesuatu3">
                                                                            <input class="form-check-input " type="radio" name="meletakkansegalasesuatu" id="meletakkansegalasesuatu3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="meletakkansegalasesuatu4">
                                                                            <input class="form-check-input " type="radio" name="meletakkansegalasesuatu" id="meletakkansegalasesuatu4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="meletakkansegalasesuatu5">
                                                                            <input class="form-check-input " type="radio" name="meletakkansegalasesuatu" id="meletakkansegalasesuatu5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kreatif dan inovatif dalam mengembangkan kualitas pekerjaan</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="kreatifdaninovatif1">
                                                                            <input class="form-check-input " required type="radio" name="kreatifdaninovatif" id="kreatifdaninovatif1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="kreatifdaninovatif2">
                                                                            <input class="form-check-input " type="radio" name="kreatifdaninovatif" id="kreatifdaninovatif2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="kreatifdaninovatif3">
                                                                            <input class="form-check-input " type="radio" name="kreatifdaninovatif" id="kreatifdaninovatif3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="kreatifdaninovatif4">
                                                                            <input class="form-check-input " type="radio" name="kreatifdaninovatif" id="kreatifdaninovatif4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="kreatifdaninovatif5">
                                                                            <input class="form-check-input " type="radio" name="kreatifdaninovatif" id="kreatifdaninovatif5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Mampu membuat keputusan terbaik dengan arif dan bijaksana</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="keputusanterbaik1">
                                                                            <input class="form-check-input " required type="radio" name="keputusanterbaik" id="keputusanterbaik1" value="Sangat rendah">
                                                                        <span></span>
                                                                    </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="keputusanterbaik2">
                                                                            <input class="form-check-input " type="radio" name="keputusanterbaik" id="keputusanterbaik2" value="Rendah">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="keputusanterbaik3">
                                                                            <input class="form-check-input " type="radio" name="keputusanterbaik" id="keputusanterbaik3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="keputusanterbaik4">
                                                                            <input class="form-check-input " type="radio" name="keputusanterbaik" id="keputusanterbaik4" value="Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label class="m-radio m-radio--solid m-radio--success" for="keputusanterbaik5">
                                                                            <input class="form-check-input " type="radio" name="keputusanterbaik" id="keputusanterbaik5" value="Sangat Tinggi">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                    ...
                                                    <br>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_profil_lingkungan_kerja" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    ...
                                                    <br>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_kemahasiswaan_nu" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                ...
                                <div class="m-portlet__body" style="margin-top: -40px">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Organisasi apa yang pernah saudara ikuti selama kuliah di Unisma dan sebagai apa?</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-6">
                                                        <input type="text" placeholder="Himaprodi / Sekretaris" name="organisasi_dalam_kemahasiswaan" class="form-control" >
                                                        </div>
                                                        <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_organisasi_dalam_kemahasiswaan" type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="m-portlet m-portlet--creative m-portlet--bordered-semi" style="margin-bottom: 0.5rem;">
                                ...
                                <div class="m-portlet__body" style="margin-top: -40px">
                                    <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" style="margin-top: -20px">
                                        <div class="m-portlet__body">
                                            <b>Apakah keikutsertaan saudara dalam organisasi tersebut berpengaruh terhadap capaian karir saat ini? </b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="pengaruh_organisasi1">
                                                            <input type="radio" name="pengaruh_organisasi" id="pengaruh_organisasi1" value="Sangat berpengaruh">
                                                            Sangat berpengaruh
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="pengaruh_organisasi2">
                                                            <input type="radio" name="pengaruh_organisasi" id="pengaruh_organisasi2" value="Berpengaruh">
                                                            Berpengaruh
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="pengaruh_organisasi3">
                                                            <input type="radio" name="pengaruh_organisasi" id="pengaruh_organisasi3" value="Cukup berpengaruh">
                                                            Cukup berpengaruh
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success" for="pengaruh_organisasi4">
                                                            <input type="radio" name="pengaruh_organisasi" id="pengaruh_organisasi4" value="Tidak berpengaruh">
                                                            Tidak berpengaruh
                                                        <span></span>
                                                        </label>
                                                    </div>
                                                    <br>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197" class="btn waves-effect waves-light" id="reset_pengaruh_organisasi" type="button"><b>Clear Selection</b>
