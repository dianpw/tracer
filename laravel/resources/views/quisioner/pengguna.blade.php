                        ...
                        <div class="m-stack m-stack--ver m-stack--general">
                            ...
                            <div class="m-stack__item m-stack__item--middle m-brand__tools">
                                ...
                                <a id="click_alumni2" style="color: white" id="m_aside_header_topbar_mobile_toggle"
                                    ...
                                    <div style="margin-bottom:11px;"><b><i class="la la-user"></i> </b> Alumni,
                                    </div><br><br><br>
                                    <b>{{ $str }}</b>
                                </a>
                                <!-- BEGIN: Topbar Toggler -->
                        ...
                        <div id="m_header_topbar"
                            ...
                            <div class="m-stack__item m-topbar__nav-wrapper" style="margin-top:-150px">
                                <a id="click_alumni" href="javascript:;">
                                    <b style="color:whitesmoke"><i class="la la-user"></i> Alumni,
                                        ...
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
                                                    ...
                                                    <input id="tahun_masuk" type="text" name="tahun_masuk" required
                                                        placeholder="Jawaban Anda" class="form-control m-input">
                                                    <span class="m-form__help">&nbsp</span>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class=""> Tahun Lulus sesuai yang tertulis di
                                                        Ijazah</label>
                                                    <input id="tahun_lulus" type="text" class="form-control m-input"
                                                        name="tahun_lulus" placeholder="Jawaban Anda">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <div class="col-lg-6">
