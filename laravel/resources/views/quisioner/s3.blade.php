                        ...
                        <div class="m-stack m-stack--ver m-stack--general">
                            ...
                            <div class="m-stack__item m-stack__item--middle m-brand__tools">
                                ...
                                <a id="click_alumni2" style="color: white" id="m_aside_header_topbar_mobile_toggle"
                                    ...
                                    <div style="margin-bottom:11px;"><b><i class="la la-user"></i> </b> Alumni S3,
                                    </div><br><br><br>
                                    <b>{{ $str }}</b>
                                </a>
                                <!-- BEGIN: Topbar Toggler -->
                        ...
                        <div id="m_header_topbar"
                            ...
                            <div class="m-stack__item m-topbar__nav-wrapper" style="margin-top:-150px">
                                <a id="click_alumni" href="javascript:;">
                                    <b style="color:whitesmoke"><i class="la la-user"></i> Alumni S3,
            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
                <div class="m-content" style="margin-top: -40px; margin-bottom:-15px">
                    <div class="isi_biodata">
                        <form id="survey-form" method="POST" action="{{ url('submit-tracer-s3') }}">
                            @csrf
                    ...
                    <div class="isi_quisioner fade-in">
                        ...
                        <!--[Apa nama Perguruan Tinggi terakhir sebelum menempuh pendidikan di S3 UNISMA?]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apa nama Perguruan Tinggi terakhir sebelum menempuh pendidikan di S3
                                            UNISMA?<b style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <input class="form-control" required
                                                            placeholder="Jawaban Anda" type="text" name="univs1"
                                                            id="univs1">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_univs1"
                        ...
                        <!--[Apa Program Studi yang Anda ambil sebelum menempuh pendidikan di S3 UNISMA?]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            style="margin-bottom: 0.5rem;">
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apa Program Studi yang Anda ambil sebelum menempuh pendidikan di S3 UNISMA?<b
                                                style="color:red">*).required</b>
                                            <div class="form-group m-form__group row" style="margin-left: -40px">
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <input class="form-control" required
                                                            placeholder="Jawaban Anda" type="text" name="prodis1"
                                                            id="prodis1">
                                                    </div>
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            class="btn waves-effect waves-light" id="reset_prodis1"
                                                            type="button"><b>Clear Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Tahun berapa Anda lulus S2?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="input-group mb-3">
                                                    <input id="masuks1" type="text" class="form-control m-input"
                                                        name="masuks1" placeholder="Jawaban anda..">
                                                </div>
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light" id="reset_masuks1"
                                                        type="button"><b>Clear Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <!--[Apakah Anda bekerja sebelum kuliah di S3 UNISMA?]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            style="margin-bottom: 0.5rem;">
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah Anda bekerja sebelum kuliah di S3 UNISMA?<b
                                                style="color:red">*).required</b>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success"
                                                            for="riwayat_kerja">
                                                            <input type="radio" required name="riwayat_kerja"
                                                                id="riwayat_kerja"
                                                                value="Ya, bekerja dan tetap melanjutkan bekerja">
                                                    ...
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success"
                                                            for="riwayat_kerja1">
                                                            <input type="radio" name="riwayat_kerja" id="riwayat_kerja1"
                                                                value="Ya, bekerja tapi berhenti saat masuk kuliah di program S3 UNISMA">
                                                            Ya, bekerja tapi berhenti saat masuk kuliah di program S3
                                                            UNISMA
                                                            <span></span>
                                                        </label>
                                                    </div>
                                                    <div class="form-check">
                                                        <label class="m-radio m-radio--solid m-radio--success"
                                                            for="riwayat_kerja2">
                                                            <input type="radio" name="riwayat_kerja" id="riwayat_kerja2"
                                                                value="Tidak">
                                                            Tidak
                                                            <span></span>
                                                        </label>
                                                    ...
                                                    <div align="right">
                                                        <button style="background-color:white;color:#97c197"
                                                            ...
                                                            id="reset_riwayat_kerja" type="button"><b>Clear
                                                                Selection</b>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="m-portlet__head">
                                <div class="m-portlet__head-caption">
                                    <div class="m-portlet__head-title">
                                        ...
                                        <h3 class="m-portlet__head-text">Kegiatan Pendidikan dan Pengalaman
                                            Pembelajaran</h3>
                                        <h2 class="m-portlet__head-label m-portlet__head-label--success">
                        ...
                        <!--[Apakah pendidikan yang diambil di S3 Unisma sesuai dengan latar belakang pendidikan Anda?]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            style="margin-bottom: 0.5rem;">
                            <div class="m-portlet__head">
                                <div class="m-portlet__head-caption">
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah pendidikan yang diambil di S3 Unisma sesuai dengan latar belakang
                                            pendidikan Anda?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="sesuailb2">
                                                        <input type="radio" name="sesuailb" id="sesuailb2"
                                                            value="Tidak">
                                                        Tidak
                                                        <span></span>
                                                    </label>
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light" id="reset_sesuailb"
                                                        type="button"><b>Clear Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <!--[Apakah pendidikan yang diambil di S3 Unisma sesuai dengan bidang pekerjaan Anda saat ini?]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            style="margin-bottom: 0.5rem;">
                            <div class="m-portlet__head">
                                <div class="m-portlet__head-caption">
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah pendidikan yang diambil di S3 Unisma sesuai dengan bidang pekerjaan
                                            Anda saat ini?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="sesuaibp2">
                                                        <input type="radio" name="sesuaibp" id="sesuaibp2"
                                                            value="Tidak">
                                                        Tidak
                                                        <span></span>
                                                    </label>
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light" id="reset_sesuaibp"
                                                        type="button"><b>Clear Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px;">
                                    <div class="m-portlet__body">
                                        <b>Bagaimana penilaian Anda terhadap aspek belajar mengajar di bawah
                                            ...
                                            <div class="col-lg-12" style="margin-left:0px">
                                                <div class="table-demontrasive">
                                                    ...
                                                    <table class="table table-striped m-table"
                                                        ...
                                                        <tbody>
                                                            <tr class="text-center">
                                                                <td class="text-left">Kesempatan untuk
                                                                    berinteraksi dengan dosen-dosen di luar jadwal
                                                                    kuliah</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_dosen1">
                                                                            <input type="radio" required
                                                                                name="interaksi_dosen"
                                                                                id="interaksi_dosen1"
                                                                                value="Tidak sama sekali">
                                                                            <span></span></label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_dosen2">
                                                                            <input type="radio" required
                                                                                name="interaksi_dosen"
                                                                                id="interaksi_dosen2" value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_dosen3">
                                                                            <input type="radio" required
                                                                                name="interaksi_dosen"
                                                                                id="interaksi_dosen3" value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="bimbingan_akademik1">
                                                                            <input type="radio" required
                                                                                name="bimbingan_akademik"
                                                                                id="bimbingan_akademik1"
                                                                                value="Tidak sama sekali">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="bimbingan_akademik2">
                                                                            <input type="radio" required
                                                                                name="bimbingan_akademik"
                                                                                id="bimbingan_akademik2" value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="bimbingan_akademik3">
                                                                            <input type="radio" required
                                                                                name="bimbingan_akademik"
                                                                                id="bimbingan_akademik3" value="cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="bimbingan_akademik4">
                                                                            <input type="radio" required
                                                                                name="bimbingan_akademik"
                                                                                id="bimbingan_akademik4" value="Besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="bimbingan_akademik5">
                                                                            <input type="radio" required
                                                                                name="bimbingan_akademik"
                                                                                id="bimbingan_akademik5"
                                                                                value="Sangat besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kesempatan berpartisipasi
                                                                    dalam proyek riset</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="proyek_riset1">
                                                                            <input type="radio" required
                                                                                name="proyek_riset" id="proyek_riset1"
                                                                                value="Tidak sama sekali ">
                                                                            <span></span></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="proyek_riset2">
                                                                            <input type="radio" required
                                                                                name="proyek_riset" id="proyek_riset2"
                                                                                value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="proyek_riset3">
                                                                            <input type="radio" required
                                                                                name="proyek_riset" id="proyek_riset3"
                                                                                value="cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="proyek_riset4">
                                                                            <input type="radio" required
                                                                                name="proyek_riset" id="proyek_riset4"
                                                                                value="Besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="proyek_riset5">
                                                                            <input type="radio" required
                                                                                name="proyek_riset" id="proyek_riset5"
                                                                                value="Sangat besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kondisi umum belajar
                                                                    mengajar</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kondisi_belajar1">
                                                                            <input type="radio" required
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kondisi_belajar2">
                                                                            <input type="radio" required
                                                                                name="kondisi_belajar"
                                                                                id="kondisi_belajar2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kondisi_belajar3">
                                                                            <input type="radio" required
                                                                                name="kondisi_belajar"
                                                                                id="kondisi_belajar3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kondisi_belajar4">
                                                                            <input type="radio" required
                                                                                name="kondisi_belajar"
                                                                                id="kondisi_belajar4" value="Besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kesempatan untuk memasuki
                                                                    dan menjadi bagian dari jejaring ilmiah profesional
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="jejaring_ilmiah1">
                                                                            <input type="radio" required
                                                                                name="jejaring_ilmiah"
                                                                                id="jejaring_ilmiah1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="jejaring_ilmiah2">
                                                                            <input type="radio" required
                                                                                name="jejaring_ilmiah"
                                                                                id="jejaring_ilmiah2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="jejaring_ilmiah3">
                                                                            <input type="radio" required
                                                                                name="jejaring_ilmiah"
                                                                                id="jejaring_ilmiah3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="jejaring_ilmiah4">
                                                                            <input type="radio" required
                                                                                name="jejaring_ilmiah"
                                                                                id="jejaring_ilmiah4" value="Besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kesempatan untuk
                                                                    berinteraksi dengan teman</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_teman1">
                                                                            <input type="radio" required
                                                                                name="interaksi_teman"
                                                                                id="interaksi_teman1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_teman2">
                                                                            <input type="radio" required
                                                                                name="interaksi_teman"
                                                                                id="interaksi_teman2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_teman3">
                                                                            <input type="radio" required
                                                                                name="interaksi_teman"
                                                                                id="interaksi_teman3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="interaksi_teman4">
                                                                            <input type="radio" required
                                                                                name="interaksi_teman"
                                                                                id="interaksi_teman4" value="Besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kesempatan untuk
                                                                    berpartisipasi dalam pelayanan pasien</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="partisipasi_pelayanan1">
                                                                            <input type="radio" required
                                                                                name="partisipasi_pelayanan"
                                                                                id="partisipasi_pelayanan1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="partisipasi_pelayanan2">
                                                                            <input type="radio" required
                                                                                name="partisipasi_pelayanan"
                                                                                id="partisipasi_pelayanan2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="partisipasi_pelayanan3">
                                                                            <input type="radio" required
                                                                                name="partisipasi_pelayanan"
                                                                                id="partisipasi_pelayanan3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="partisipasi_pelayanan4">
                                                                            <input type="radio" required
                                                                                name="partisipasi_pelayanan"
                                                                                id="partisipasi_pelayanan4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="partisipasi_pelayanan5">
                                                                            <input type="radio" required
                                                                                name="partisipasi_pelayanan"
                                                                                id="partisipasi_pelayanan5"
                                                                                value="Sangat besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="lainnya1">
                                                                            <input type="radio" required name="lainnya"
                                                                                id="lainnya1" value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="lainnya5">
                                                                            <input type="radio" required name="lainnya"
                                                                                id="lainnya5" value="Sangat besar">
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light"
                                                        id="reset_penilaian_belajar_mengajar" type="button"><b>Clear
                                                            Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px;">
                                    <div class="m-portlet__body">
                                        <b>Bagaimana penilaian Anda terhadap kondisi fasilitas belajar di bawah
                                            ini?</b>&nbsp<b style="color:red">*).required</b>
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12" style="margin-left:0px">
                                                <div class="table-demontrasive">
                                                    ...
                                                    <table class="table table-striped m-table"
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="perpustakaan1">
                                                                            <input type="radio" required
                                                                                name="perpustakaan" id="perpustakaan1"
                                                                                value="Tidak sama sekali">
                                                                            <span></span></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="perpustakaan2">
                                                                            <input type="radio" required
                                                                                name="perpustakaan" id="perpustakaan2"
                                                                                value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="perpustakaan3">
                                                                            <input type="radio" required
                                                                                name="perpustakaan" id="perpustakaan3"
                                                                                value="Cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="perpustakaan4">
                                                                            <input type="radio" required
                                                                                name="perpustakaan" id="perpustakaan4"
                                                                                value="Sangat besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="perpustakaan5">
                                                                            <input type="radio" required
                                                                                name="perpustakaan" id="perpustakaan5"
                                                                                value="Tidak sama sekali">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Teknologi Informasi dan
                                                                    Komunikasi</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="tik1">
                                                                            <input type="radio" required name="tik"
                                                                                id="tik1" value="Tidak sama sekali">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="modul1">
                                                                            <input type="radio" required name="modul"
                                                                                id="modul1" value="Tidak sama sekali ">
                                                                            <span></span></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Ruang belajar/ruang kuliah
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_kuliah1">
                                                                            <input type="radio" required
                                                                                name="ruang_kuliah" id="ruang_kuliah1"
                                                                                value="Tidak sama sekali ">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_kuliah2">
                                                                            <input type="radio" required
                                                                                name="ruang_kuliah" id="ruang_kuliah2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_kuliah3">
                                                                            <input type="radio" required
                                                                                name="ruang_kuliah" id="ruang_kuliah3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_kuliah4">
                                                                            <input type="radio" required
                                                                                name="ruang_kuliah" id="ruang_kuliah4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_kuliah5">
                                                                            <input type="radio" required
                                                                                name="ruang_kuliah" id="ruang_kuliah5"
                                                                                value="Sangat besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_belajar1">
                                                                            <input type="radio" required
                                                                                name="ruang_belajar" id="ruang_belajar1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_belajar2">
                                                                            <input type="radio" required
                                                                                name="ruang_belajar" id="ruang_belajar2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_belajar3">
                                                                            <input type="radio" required
                                                                                name="ruang_belajar" id="ruang_belajar3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_belajar4">
                                                                            <input type="radio" required
                                                                                name="ruang_belajar" id="ruang_belajar4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="ruang_belajar5">
                                                                            <input type="radio" required
                                                                                name="ruang_belajar" id="ruang_belajar5"
                                                                                value="Sangat besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="lab1">
                                                                            <input type="radio" required name="lab"
                                                                                id="lab1" value="Tidak sama sekali">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Variasi matakuliah yang
                                                                    ditawarkan</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="variasi1">
                                                                            <input type="radio" required name="variasi"
                                                                                id="variasi1" value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="variasi5">
                                                                            <input type="radio" required name="variasi"
                                                                                id="variasi5" value="Sangat besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kantin1">
                                                                            <input type="radio" required name="kantin"
                                                                                id="kantin1" value="Tidak sama sekali">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Pusat kegiatan mahasiswa dan
                                                                    fasilitasnya, ruang rekreasi</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kegiatan_mahasiswa1">
                                                                            <input type="radio" required
                                                                                name="kegiatan_mahasiswa"
                                                                                id="kegiatan_mahasiswa1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kegiatan_mahasiswa2">
                                                                            <input type="radio" required
                                                                                name="kegiatan_mahasiswa"
                                                                                id="kegiatan_mahasiswa2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kegiatan_mahasiswa3">
                                                                            <input type="radio" required
                                                                                name="kegiatan_mahasiswa"
                                                                                id="kegiatan_mahasiswa3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kegiatan_mahasiswa4">
                                                                            <input type="radio" required
                                                                                name="kegiatan_mahasiswa"
                                                                                id="kegiatan_mahasiswa4" value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kegiatan_mahasiswa5">
                                                                            <input type="radio" required
                                                                                name="kegiatan_mahasiswa"
                                                                                id="kegiatan_mahasiswa5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Fasililtas layanan kesehatan
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="layanan_kesehatan1">
                                                                            <input type="radio" required
                                                                                name="layanan_kesehatan"
                                                                                id="layanan_kesehatan1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="layanan_kesehatan2">
                                                                            <input type="radio" required
                                                                                name="layanan_kesehatan"
                                                                                id="layanan_kesehatan2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="layanan_kesehatan3">
                                                                            <input type="radio" required
                                                                                name="layanan_kesehatan"
                                                                                id="layanan_kesehatan3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="layanan_kesehatan4">
                                                                            <input type="radio" required
                                                                                name="layanan_kesehatan"
                                                                                id="layanan_kesehatan4" value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="layanan_kesehatan5">
                                                                            <input type="radio" required
                                                                                name="layanan_kesehatan"
                                                                                id="layanan_kesehatan5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Beasiswa dan/atau bantuan
                                                                    biaya hidup</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="biaya_hidup1">
                                                                            <input type="radio" required
                                                                                name="biaya_hidup" id="biaya_hidup1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="biaya_hidup2">
                                                                            <input type="radio" required
                                                                                name="biaya_hidup" id="biaya_hidup2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="biaya_hidup3">
                                                                            <input type="radio" required
                                                                                name="biaya_hidup" id="biaya_hidup3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="biaya_hidup4">
                                                                            <input type="radio" required
                                                                                name="biaya_hidup" id="biaya_hidup4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="biaya_hidup5">
                                                                            <input type="radio" required
                                                                                name="biaya_hidup" id="biaya_hidup5"
                                                                                value="Sangat besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="parkir1">
                                                                            <input type="radio" required name="parkir"
                                                                                id="parkir1" value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="toilet1">
                                                                            <input type="radio" required name="toilet"
                                                                                id="toilet1" value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="ibadah1">
                                                                            <input type="radio" required name="ibadah"
                                                                                id="ibadah1" value="Tidak sama sekali">
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light"
                                                        id="reset_penilaian_fasilitas_belajar" type="button"><b>Clear
                                                            Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px;">
                                    <div class="m-portlet__body">
                                        <b>Bagaimana penilaian Anda terhadap pengalaman belajar di bawah ini?</b>&nbsp<b
                                            style="color:red">*).required</b>
                                        <div class="form-group m-form__group row">
                                            <div class="col-lg-12" style="margin-left:0px">
                                                <div class="table-demontrasive">
                                                    ...
                                                    <table class="table table-striped m-table"
                                                        ...
                                                        <tbody>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="kelas1">
                                                                            <input type="radio" required name="kelas"
                                                                                id="kelas1" value="Tidak sama sekali">
                                                                            <span></span></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="kelas5">
                                                                            <input type="radio" required name="kelas"
                                                                                id="kelas5" value="Tidak sama sekali">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                </td>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Magang/kerja
                                                                    lapangan/praktikum</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="magang_kerja1">
                                                                            <input type="radio" required
                                                                                name="magang_kerja" id="magang_kerja1"
                                                                                value="Tidak sama sekali">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="magang_kerja2">
                                                                            <input type="radio" required
                                                                                name="magang_kerja" id="magang_kerja2"
                                                                                value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="magang_kerja3">
                                                                            <input type="radio" required
                                                                                name="magang_kerja" id="magang_kerja3"
                                                                                value="cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="magang_kerja4">
                                                                            <input type="radio" required
                                                                                name="magang_kerja" id="magang_kerja4"
                                                                                value="Besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="magang_kerja5">
                                                                            <input type="radio" required
                                                                                name="magang_kerja" id="magang_kerja5"
                                                                                value="Sangat besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="pengabdian1">
                                                                            <input type="radio" required
                                                                                name="pengabdian" id="pengabdian1"
                                                                                value="Tidak sama sekali">
                                                                            <span></span></label>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="pengabdian2">
                                                                            <input type="radio" required
                                                                                name="pengabdian" id="pengabdian2"
                                                                                value="Tidak">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="pengabdian3">
                                                                            <input type="radio" required
                                                                                name="pengabdian" id="pengabdian3"
                                                                                value="cukup">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="pengabdian4">
                                                                            <input type="radio" required
                                                                                name="pengabdian" id="pengabdian4"
                                                                                value="Besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="pengabdian5">
                                                                            <input type="radio" required
                                                                                name="pengabdian" id="pengabdian5"
                                                                                value="Sangat besar">
                                                                            <span></span>
                                                                        </label>
                                                                    </div>
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Pelaksanaan riset/penulisan
                                                                    thesis</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="thesis1">
                                                                            <input type="radio" required name="thesis"
                                                                                id="thesis1" value="Tidak sama sekali">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Organisasi kemahasiswaan
                                                                    internal fakultas</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_internal1">
                                                                            <input type="radio" required
                                                                                name="organisasi_internal"
                                                                                id="organisasi_internal1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_internal2">
                                                                            <input type="radio" required
                                                                                name="organisasi_internal"
                                                                                id="organisasi_internal2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_internal3">
                                                                            <input type="radio" required
                                                                                name="organisasi_internal"
                                                                                id="organisasi_internal3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_internal4">
                                                                            <input type="radio" required
                                                                                name="organisasi_internal"
                                                                                id="organisasi_internal4" value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_internal5">
                                                                            <input type="radio" required
                                                                                name="organisasi_internal"
                                                                                id="organisasi_internal5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Organisasi kemahasiswaan
                                                                    lintas fakultas di UNISMA</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas1">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas"
                                                                                id="organisasi_lintas1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas2">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas"
                                                                                id="organisasi_lintas2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas3">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas"
                                                                                id="organisasi_lintas3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas4">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas"
                                                                                id="organisasi_lintas4" value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas5">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas"
                                                                                id="organisasi_lintas5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Organisasi kemahasiswaaan
                                                                    lintas universitas nasional</td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_nasional1">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_nasional"
                                                                                id="organisasi_lintas_nasional1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_nasional2">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_nasional"
                                                                                id="organisasi_lintas_nasional2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_nasional3">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_nasional"
                                                                                id="organisasi_lintas_nasional3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_nasional4">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_nasional"
                                                                                id="organisasi_lintas_nasional4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_nasional5">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_nasional"
                                                                                id="organisasi_lintas_nasional5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Organisasi kemahasiswaan
                                                                    lintas universitas lintas negara (internasional)
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_negara1">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_negara"
                                                                                id="organisasi_lintas_negara1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_negara2">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_negara"
                                                                                id="organisasi_lintas_negara2"
                                                                                value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_negara3">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_negara"
                                                                                id="organisasi_lintas_negara3"
                                                                                value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_negara4">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_negara"
                                                                                id="organisasi_lintas_negara4"
                                                                                value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="organisasi_lintas_negara5">
                                                                            <input type="radio" required
                                                                                name="organisasi_lintas_negara"
                                                                                id="organisasi_lintas_negara5"
                                                                                value="Sangat besar">
                                                            ...
                                                            <tr class="text-center">
                                                                <td class="text-left">Kegiatan ekstrakurikuler
                                                                </td>
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="ekstrakurikuler1">
                                                                            <input type="radio" required
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="ekstrakurikuler2">
                                                                            <input type="radio" required
                                                                                name="ekstrakurikuler"
                                                                                id="ekstrakurikuler2" value="Tidak">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="ekstrakurikuler3">
                                                                            <input type="radio" required
                                                                                name="ekstrakurikuler"
                                                                                id="ekstrakurikuler3" value="Cukup">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="ekstrakurikuler4">
                                                                            <input type="radio" required
                                                                                name="ekstrakurikuler"
                                                                                id="ekstrakurikuler4" value="Besar">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            class="m-radio m-radio--solid m-radio--success"
                                                                            for="olahraga1">
                                                                            <input type="radio" required name="olahraga"
                                                                                id="olahraga1"
                                                                                value="Tidak sama sekali">
                                                                ...
                                                                <td>
                                                                    <div class="form-check">
                                                                        <label
                                                                            ...
                                                                            for="olahraga5">
                                                                            <input type="radio" required name="olahraga"
                                                                                id="olahraga5" value="Sangat besar">
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light"
                                                        id="reset_penilaian_pengalaman_belajar" type="button"><b>Clear
                                                            Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                            ...
                            <div class="m-portlet__head">
                                <div class="m-portlet__head-caption">
                                    <div class="m-portlet__head-title">
                                        ...
                                        <h3 class="m-portlet__head-text">Pencarian Kerja dan Transisi ke Dunia Kerja
                                        </h3>
                                        <h2 class="m-portlet__head-label m-portlet__head-label--success">
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah Anda sudah mempunyai pekerjaan saat lulus S3 UNISMA?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="sudah_kerja">
                                                        <input type="radio" name="sudah_kerja" id="sudah_kerja"
                                                            value="Sudah">
                                                        Sudah
                                                        <span></span>
                                                    </label>
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="sudah_kerja2">
                                                        <input type="radio" name="sudah_kerja" id="sudah_kerja2"
                                                            value="Belum">
                                                        Belum
                                                        <span></span>
                                                    </label>
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light" id="reset_sudah_kerja"
                                                        type="button"><b>Clear Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                        ...
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            ...
                            <div class="m-portlet__body" style="margin-top: -40px">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Apakah Anda pindah ke pekerjaan baru setelah lulus S3 UNISMA?</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="pindah_kerja">
                                                        <input type="radio" name="pindah_kerja" id="pindah_kerja"
                                                            value="Ya">
                                                        Ya
                                                        <span></span>
                                                    </label>
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="pindah_kerja2">
                                                        <input type="radio" name="pindah_kerja" id="pindah_kerja2"
                                                            value="Tidak, saya tetap bekerja di pekerjaan terdahulu">
                                                ...
                                                <div align="right">
                                                    <button style="background-color:white;color:#97c197"
                                                        class="btn waves-effect waves-light" id="reset_pindah_kerja"
                                                        type="button"><b>Clear Selection</b>
                                                    </button>
                                                </div>
                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-control"
                                                                    ...
                                                                    name="pertanyaanf3_input_sebelum" id="univs1">
                                                            </div>
                                                        </td>
                                                        <td>&nbsp bulan sebelum lulus S3 UNISMA</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <div class="form-check">
                                                        ...
                                                        <td>
                                                            <div class="form-check">
                                                                <input class="form-control"
                                                                    placeholder="Jawaban Anda" type="text" disabled
                                                                    name="pertanyaanf3_input_setelah" id="univs1">
                                                            </div>
                                                        </td>
                                                        <td>&nbsp bulan setelah lulus S3 UNISMA</td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="2">
                                                            <div class="form-check">
                        ...
                        <!--[Bagaimana Anda mencari/mendapatkan pekerjaan setelah lulus S3 UNISMA? Jawaban bisa lebih dari satu]-->
                        <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                            style="margin-bottom: 0.5rem;">
                            <div class="m-portlet__body">
                                <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                    style="margin-top: -20px">
                                    <div class="m-portlet__body">
                                        <b>Bagaimana Anda mencari/mendapatkan pekerjaan setelah lulus S3
                                            UNISMA? (<i>jawaban boleh lebih dari satu</i>)</b>
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                <div class="form-check">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-checkbox m-checkbox--solid m-checkbox--success"
                                                        for="pertanyaanf416">
                                                        <input type="checkbox"
                                                            name="pertanyaanf4_ditawari_pekerjaan_baru"
                                                            id="pertanyaanf416" value="1">
                                        ...
                                        <div class="form-group m-form__group row" style="margin-left: -40px">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        ...
                                                        <input type="radio" name="status_kerja" id="status_kerja2"
                                                            value="Saya bekerja fulltime dan sedang mencari pekerjaan baru">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        ...
                                                        <input type="radio" name="status_kerja" id="status_kerja4"
                                                            value="Saya bekerja part-time dan sedang mencari pekerjaan baru">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        ...
                                                        <input type="radio" name="status_kerja" id="status_kerja5"
                                                            value="Saya tidak/belum bekerja dan sedang mencari pekerjaan">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="status_kerja6">
                                                        <input type="radio" name="status_kerja" id="status_kerja6"
                                                            value="Saya tidak/belum bekerja karena menikah">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="status_kerja7">
                                                        <input type="radio" name="status_kerja" id="status_kerja7"
                                                            value="Saya tidak/belum bekerja karena sibuk dengan keluarga dan anak-anak.">
                                                        Saya tidak/belum bekerja karena sibuk dengan keluarga dan
                                                        anak-anak.
                                                        <span></span>
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="status_kerja8">
                                                        <input type="radio" name="status_kerja" id="status_kerja8"
                                                            value="Saya tidak/belum bekerja karena memang memilih tidak bekerja.">
                                                ...
                                                <div class="form-check">
                                                    <label class="m-radio m-radio--solid m-radio--success"
                                                        for="status_kerja9">
                                                        <input type="radio" name="status_kerja" id="status_kerja9"
                                                            value="Saya tidak bekerja karena alasan lain">
                                                                        ...
                                                                        <div class="form-check">
                                                                            <label
                                                                                ...
                                                                                <input class="form-check-input"
                                                                                    type="checkbox"
                                                                                    name="organisasi_non_profit[]"
                                                                                    id="organisasilokal" value="lokal">
                                                                                <span></span>
                                                                            </label>
                                                                        </div>
                                                                    </td>
                                    ...
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            ...
                                            <div align="right">
                                                <button style="background-color:white;color:#97c197"
                                                    class="btn waves-effect waves-light"
                                                    id="reset_nama_atasan_langsung" type="button"><b>Clear Selection</b>
                                    ...
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            ...
                                            <div align="right">
                                                <button style="background-color:white;color:#97c197"
                                                    class="btn waves-effect waves-light"
                                                    id="reset_nohp_atasan_langsung" type="button"><b>Clear Selection</b>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Berapa nominal kenaikan pendapatan rata-rata Anda setelah mengambil S3
                                        UNISMA?</b>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="input-group mb-6">
                                                <input type="text" onkeypress="return isNumberKey(event)"
                                                    placeholder="5000000" name="kenaikan_s2"
                                                    class="form-control loan_max_amount">
                                            </div>
                                            <div align="right">
                                                <button style="background-color:white;color:#97c197"
                                                    class="btn waves-effect waves-light" id="reset_kenaikan_s2"
                                                    type="button"><b>Clear Selection</b>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <!--[Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bawah ini yang Anda kuasai? (A)]-->
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        style="margin-bottom: 0.5rem;">
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bawah ini yang Anda
                                        kuasai? (A)</b>&nbsp<b style="color:red">*).required</b>
                                    <br><br>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                            ...
                                            <div class="table-demontrasive">
                                                <table class="table table-striped m-table"
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Keahlian Berdasarkan Bidang
                                                                Ilmu</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                    ...
                    <!--[Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bwah ini diperlukan dalam pekerjaan? (B)]-->
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        style="margin-bottom: 0.5rem;">
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Pada saat lulus S3 UNISMA, pada tingkat mana kompetensi di bwah ini diperlukan
                                        dalam pekerjaan? (B)</b>&nbsp<b style="color:red">*).required</b>
                                    <br><br>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="table-demontrasive">
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Seberapa besar peran kompetensi yang diperoleh di S3 UNISMA berikut ini dalam
                                        ...
                                        <div class="col-lg-12">
                                            <div class="table-demontrasive">
                                                <table class="table table-striped m-table"
                                                    ...
                                                    <tbody>
                                                        <tr class="text-center">
                                                            <td class="text-left">Kompetensi multidisiplin di
                                                                bidang program studi Anda</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="multidisiplin2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="multidisiplin" id="multidisiplin2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="multidisiplin3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="multidisiplin" id="multidisiplin3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="multidisiplin4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="multidisiplin" id="multidisiplin4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="multidisiplin5">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="multidisiplin" id="multidisiplin5"
                                                                            value="Sangat Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="isu_terkini1">
                                                                        <input class="form-check-input " type="radio"
                                                                            required name="isu_terkini"
                                                                            id="isu_terkini1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="isu_terkini2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="isu_terkini" id="isu_terkini2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="isu_terkini3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="isu_terkini" id="isu_terkini3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="isu_terkini4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="isu_terkini" id="isu_terkini4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="isu_terkini5">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="isu_terkini" id="isu_terkini5"
                                                                            value="Sangat Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="keterampilan_internet"
                                                                            id="keterampilan_internet1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_internet"
                                                                            id="keterampilan_internet2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_internet"
                                                                            id="keterampilan_internet3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_internet"
                                                                            id="keterampilan_internet4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="keterampilan_komputer"
                                                                            id="keterampilan_komputer1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="berfikir_kritis1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="berfikir_kritis"
                                                                            id="berfikir_kritis1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="berfikir_kritis2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berfikir_kritis" id="berfikir_kritis2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="berfikir_kritis3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berfikir_kritis" id="berfikir_kritis3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="berfikir_kritis4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berfikir_kritis" id="berfikir_kritis4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="berfikir_kritis5">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berfikir_kritis" id="berfikir_kritis5"
                                                                            value="Sangat Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="keterampilan_riset"
                                                                            id="keterampilan_riset1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_riset"
                                                                            id="keterampilan_riset2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_riset"
                                                                            id="keterampilan_riset3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="keterampilan_riset"
                                                                            id="keterampilan_riset4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="kemampuan_belajar"
                                                                            id="kemampuan_belajar1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kemampuan_belajar"
                                                                            id="kemampuan_belajar2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kemampuan_belajar"
                                                                            id="kemampuan_belajar3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kemampuan_belajar"
                                                                            id="kemampuan_belajar4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                                ...
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            ...
                                                                            id="kemampuan_komunikasi2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kemampuan_komunikasi"
                                                                            id="kemampuan_komunikasi3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kemampuan_komunikasi"
                                                                            id="kemampuan_komunikasi4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="di_bawah_tekanan"
                                                                            id="di_bawah_tekanan1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="di_bawah_tekanan"
                                                                            id="di_bawah_tekanan2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="di_bawah_tekanan"
                                                                            id="di_bawah_tekanan3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="di_bawah_tekanan"
                                                                            id="di_bawah_tekanan4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="di_bawah_tekanan"
                                                                            id="di_bawah_tekanan5" value="Sangat Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="manajemen_waktu"
                                                                            id="manajemen_waktu1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_waktu" id="manajemen_waktu2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_waktu" id="manajemen_waktu3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_waktu" id="manajemen_waktu4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="bekerja_mandiri"
                                                                            id="bekerja_mandiri1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_mandiri" id="bekerja_mandiri2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_mandiri" id="bekerja_mandiri3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_mandiri" id="bekerja_mandiri4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Bekerja dalam tim/bekerjasama
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="bekerja_tim1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="bekerja_tim"
                                                                            id="bekerja_tim1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="bekerja_tim2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_tim" id="bekerja_tim2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="bekerja_tim3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_tim" id="bekerja_tim3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="bekerja_tim4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="bekerja_tim" id="bekerja_tim4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan dalam memecahkan
                                                                masalah</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="pemecahan_masalah"
                                                                            id="pemecahan_masalah1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            ...
                                                                            id="pemecahan_masalah2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="pemecahan_masalah"
                                                                            id="pemecahan_masalah3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="pemecahan_masalah"
                                                                            id="pemecahan_masalah4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="negosiasi1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="negosiasi"
                                                                            id="negosiasi1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="analisis1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="analisis" id="analisis1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="toleransi1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="toleransi"
                                                                            id="toleransi1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="adaptasi1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="adaptasi" id="adaptasi1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="loyalitas1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="loyalitas"
                                                                            id="loyalitas1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="integritas1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="integritas"
                                                                            id="integritas1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="integritas2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="integritas" id="integritas2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="integritas3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="integritas" id="integritas3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="integritas4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="integritas" id="integritas4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Bekerja dengan orang yang
                                                                berbeda budaya maupun latar belakang</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="beda_budaya1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="beda_budaya"
                                                                            id="beda_budaya1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="beda_budaya2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="beda_budaya" id="beda_budaya2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="beda_budaya3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="beda_budaya" id="beda_budaya3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="beda_budaya4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="beda_budaya" id="beda_budaya4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="kepemimpinan2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kepemimpinan" id="kepemimpinan2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="kepemimpinan3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kepemimpinan" id="kepemimpinan3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="kepemimpinan4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="kepemimpinan" id="kepemimpinan4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan dalam memegang
                                                                tanggungjawab</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="tanggungjawab2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="tanggungjawab" id="tanggungjawab2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="tanggungjawab3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="tanggungjawab" id="tanggungjawab3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="tanggungjawab4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="tanggungjawab" id="tanggungjawab4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="inisiatif1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="inisiatif"
                                                                            id="inisiatif1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="manajemen_proyek"
                                                                            id="manajemen_proyek1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                                ...
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            ...
                                                                            id="manajemen_proyek2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_proyek"
                                                                            id="manajemen_proyek3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_proyek"
                                                                            id="manajemen_proyek4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="manajemen_proyek"
                                                                            id="manajemen_proyek5" value="Sangat Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan untuk memresentasikan
                                                                ide/produk/laporan</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        for="presentasi1">
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="presentasi"
                                                                            id="presentasi1" value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="presentasi2">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="presentasi" id="presentasi2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="presentasi3">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="presentasi" id="presentasi3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        for="presentasi4">
                                                                        <input class="form-check-input " type="radio"
                                                                            name="presentasi" id="presentasi4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan dalam menulis
                                                                laporan, memo dan dokumen</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        class="m-radio m-radio--solid m-radio--success"
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="menulis_laporan"
                                                                            id="menulis_laporan1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="menulis_laporan" id="menulis_laporan2"
                                                                            value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="menulis_laporan" id="menulis_laporan3"
                                                                            value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="menulis_laporan" id="menulis_laporan4"
                                                                            value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan untuk terus belajar
                                                                sepanjang hayat</td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="belajar_sepanjang_hayat"
                                                                            id="belajar_sepanjang_hayat1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="belajar_sepanjang_hayat"
                                                                            id="belajar_sepanjang_hayat2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="belajar_sepanjang_hayat"
                                                                            id="belajar_sepanjang_hayat3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="belajar_sepanjang_hayat"
                                                                            id="belajar_sepanjang_hayat4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr class="text-center">
                                                            <td class="text-left">Kemampuan berbahasa Inggris
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " required
                                                                            type="radio" name="berbahasa_inggris"
                                                                            id="berbahasa_inggris1"
                                                                            value="Tidak Sama Sekali">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berbahasa_inggris"
                                                                            id="berbahasa_inggris2" value="Tidak">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berbahasa_inggris"
                                                                            id="berbahasa_inggris3" value="Cukup">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="form-check">
                                                                    <label
                                                                        ...
                                                                        <input class="form-check-input " type="radio"
                                                                            name="berbahasa_inggris"
                                                                            id="berbahasa_inggris4" value="Besar">
                                                                        <span></span>
                                                                    </label>
                                                                </div>
                                                            </td>
                                            ...
                                            <div align="right">
                                                <button style="background-color:white;color:#97c197"
                                                    class="btn waves-effect waves-light" id="reset_peran_kompetensi"
                                                    type="button"><b>Clear Selection</b>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Seberapa erat hubungan antara bidang studi dengan pekerjaan Anda?</b>&nbsp<b
                                        style="color:red">*).required</b>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="form-check">
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Tingkat pendidikan apa yang paling tepat/sesuai untuk pekerjaan Anda saat
                                        ini?</b>&nbsp<b style="color:red">*).required</b>
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="form-check">
                    ...
                    <div class="m-portlet m-portlet--creative m-portlet--bordered-semi"
                        ...
                        <div class="m-portlet__body">
                            <div class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed"
                                style="margin-top: -20px">
                                <div class="m-portlet__body">
                                    <b>Jika menurut Anda pekerjaan Anda saat ini tidak sesuai dengan pendidikan Anda,
                                        mengapa Anda mengambilnya? </b>(<i> Jawaban bisa lebih dari satu</i>)
                                    <div class="form-group m-form__group row" style="margin-left: -40px">
                                        <div class="col-lg-12">
                                            <div class="form-check">
                                                <label class="m-checkbox m-checkbox--solid m-checkbox--success"
