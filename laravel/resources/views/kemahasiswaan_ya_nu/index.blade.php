        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <br><br>
                    <div id="organisasi_kemahasiswaan"></div>
                </div>
            </div>
            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_kemahasiswaan_ya_nu')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-kemahasiswaan-ya-nu")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
            autoWidth:         true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        $.ajax({
            url: "{{url('graph-kemahasiswaan-ya-nu')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            ...
            Highcharts.chart('organisasi_kemahasiswaan', {
                ...
                title: {
                    text: 'Kemahasiswaan NU yang diikuti - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
