        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <div id="chart_situasi_saat_ini_1"></div>
                </div>
            </div>
            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">     
                        <a href="{{url('export_situasi_saat_ini_1')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-situasi-saat-ini-I")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-situasi-saat-ini-I')}}"+ '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){

            Highcharts.chart('chart_situasi_saat_ini_1', {
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'Status Saat ini - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
                    text: 'Source: <a href="">http://cdc.unisma.ac.id/tracer_study/</a>'
                },
                xAxis: {
                    categories: ['Sudah Bekerja',
                                'Tidak Bekerja',
                ...
                series: [{
                    data: [
                        {y:response.sudah_bekerja[0], color:'orange'},
                        {y:response.tidak_bekerja[0], color:'red'},
