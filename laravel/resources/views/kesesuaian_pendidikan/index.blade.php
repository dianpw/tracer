            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    <div class="col-md-9">
                        <div class="m-alert m-alert--icon m-alert--air alert alert-dismissible fade show" role="alert" style="background-color: #95a57e36">
                            ...
                            <div class="m-alert__text">
                                ...
                                - Apakah pendidikan yang diambil di S2 Unisma sesuai dengan latar belakang pendidikan Anda?</br>	
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_kesesuaian_pendidikan')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-kesesuaian-pendidikan")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-kesesuaian-pendidikan')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){
                console.log(response);
                Highcharts.chart('chart_kesesuaian', {
                    chart: {
                        type: 'bar'
                    },
                    title: {
                        text: 'Kesesuaian Pendidikan - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                    },
                    subtitle: {
                        text: 'Source: <a href="">http://cdc.unisma.ac.id/tracer_study/</a>'
                    },
                    xAxis: {
                        categories: ['Sesuai dengan latar belakang pendidikan',
                                    'Tidak Sesuai dengan latar belakang pendidikan',
                                    'Sesuai dengan bidang pekerjaan saat ini',
                                    'Tidak Sesuai dengan bidang pekerjaan saat ini',
                                    ],
                        title: {
                            text: null
                        }
                    ...
                    series: [{
                        data: [
                            {y:response.yalatar_belakang[0], color:'#0074D9'},
                            {y:response.tidaklatar_belakang[0], color:'#39CCCC'},
                            {y:response.yabidang_pekerjaan[0], color:'#B10DC9'},
                            {y:response.tidakbidang_pekerjaan[0], color:'#AAAAAA'},
                        ],
                        showInLegend: true
                    }]
                });
