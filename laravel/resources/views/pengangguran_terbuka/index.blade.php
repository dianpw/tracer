        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <div id="pengangguran_terbuka"></div>
                </div>
            </div>
                    ...
                    <div class="col-md-9">
                        <div class="m-alert m-alert--icon m-alert--air alert alert-dismissible fade show" role="alert" style="background-color: #95a57e36">
                            ...
                            <div class="m-alert__text">
                                ...
                                F10. Apakah anda aktif mencari pekerjaan dalam 4 minggu terakhir? Pilihlah Satu Jawaban.
                            </div>
                           
                        </div>
                    </div>
                    <div class="col-md-3 text-right">     
                        <a href="{{url('export_pengangguran_terbuka')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
                ...
                <table cellpadding="0" class="table-striped tabel_show table table-bordered nowrap" cellspacing="0" width="100%">
                    <thead style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                        <tr>
                            ...
                            <th style="15%">Tidak</th>
                            <th style="25%">Menunggu hasil lamaran</th>
                            <th style="15%">Mulai bekerja</th>
                            <th style="15%">Belum pasti akan bekerja</th>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-pengangguran-terbuka")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('.filter-checkbox').on('change', function(e){
     ...
     $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-pengangguran-terbuka')}}"+ '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){

            Highcharts.chart('pengangguran_terbuka', {
                chart: {
                    type: 'bar'
                },
                title: {
                    text: 'Pengangguran Terbuka - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
                ...
                xAxis: {
                    categories: ['Tidak',
                                ...
                                'Ya, saya akan mulai bekerja 2 minggu kedepan',
                                'Ya, tapi saya belum pasti akan bekerja dalam 2 minggu',
                                'Lainnya'
                                ],
                    title: {
                        text: null
                ...
                series: [{
                    data: [
                        {y:response.tidak[0], color:'#0074D9'},
                        {y:response.tidak_tapi_saya_sedang_menunggu_hasil_lamaran[0], color:'#39CCCC'},
                        {y:response.ya_saya_akan_mulai_bekerja_2_minggu_kedepan[0], color:'#B10DC9'},
                        {y:response.ya_tapi_saya_belum_pasti_akan_bekerja_dalam_2_minggu[0], color:'#AAAAAA'},
