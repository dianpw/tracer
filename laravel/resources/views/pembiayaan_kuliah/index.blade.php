            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">     
                        <a href="{{url('export_pembiayaan_kuliah')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-pembiayaan-kuliah")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-pembiayaan-kuliah')}}"+ '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){

            Highcharts.chart('chart_pembiayaan', {
                chart: {
                    type: 'pie'
                },
                title: {
                    text: 'Pembiayaan Kuliah - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
