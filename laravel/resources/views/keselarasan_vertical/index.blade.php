        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <div id="chart_keselarasan_vertical"></div>
                </div>
            </div>
            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">     
                        <a href="{{url('export_keselarasan_vertical')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
                ...
                <table cellpadding="0" class="table-striped tabel_show table table-bordered nowrap" cellspacing="0" width="100%">
                    <thead style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                        <tr>
                            ...
                            <th style="15%">setingkat lebih tinggi</th>
                            <th style="25%">tingkat yang sama</th>
                            <th style="15%">setingkat lebih rendah</th>
                            <th style="15%">tidak perlu pendidikan tinggi</th>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-keselarasan-vertical")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-keselarasan-vertical')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){

            Highcharts.chart('chart_keselarasan_vertical', {
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'Keselarasan Vertical - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
                    text: 'Source: <a href="">http://cdc.unisma.ac.id/tracer_study/</a>'
                },
                xAxis: {
                    categories: ['Setingkat Lebih Tinggi',
                    'Tingkat Yang Sama',
                ...
                series: [{
                    showInLegend: true,
                    data: [
                        {y:response.setingkat_lebih_tinggi[0], color:'#0074D9'},
                        {y:response.tingkat_yang_sama[0], color:'#39CCCC'},
                        {y:response.setingkat_lebih_rendah[0], color:'#B10DC9'},
                        {y:response.tidak_perlu_pendidikan_tinggi[0], color:'#AAAAAA'},
