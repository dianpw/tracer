        ...
        <div class="tab-content">
            <div class="tab-pane" id="m_tabs_1_1" role="tabpanel">
                ...
                <div class="input-group" style="width:100%">
                    ...
                    <br><br>
                    <div id="chart_waktu_mencari_kerja"></div>
                </div>
            </div>
            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_waktu_mencari_pekerjaan')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
                ...
                <table cellpadding="0" class="table-striped tabel_show table table-bordered nowrap" cellspacing="0" width="100%">
                    <thead style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                        <tr>
                            ...
                            <th style="15%">Waktu mencari pekerjaan</th>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-waktu-mencari-pekerjaan")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	 $.ajax({
            url: "{{url('graph-waktu-mencari-pekerjaan')}}"+ '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){
                // console.log(response.bulan);
            Highcharts.chart('chart_waktu_mencari_kerja', {
                    chart: {
                    type: 'pie'
                    },
                    credits: {
                    ...
                    title: {
                        text: 'Total Mahasiswa - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>' 
                    },
                    xAxis: {
                        categories: ["1"],
                        title: {
