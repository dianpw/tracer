            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    <div class="col-md-9">
                        <div class="m-alert m-alert--icon m-alert--air alert alert-dismissible fade show" role="alert" style="background-color: #95a57e36">
                            ...
                            <div class="m-alert__text">
                                ...
                                - Apa nama Perguruan Tinggi terakhir sebelum menempuh pendidikan di S2 UNISMA?</br>	
                                - Apa Program Studi yang Anda ambil sebelum menempuh pendidikan di S2 UNISMA?</br>	
                                - Tahun berapa Anda lulus S1?</br>	
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_sebelum_kuliah')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
                ...
                <table cellpadding="0" class="table-striped tabel_show table table-bordered nowrap" cellspacing="0" width="100%">
                    <thead style="background-image: url('https://www.transparenttextures.com/patterns/sos.png');background-color: #349d44;color: #e5f6dd;">
                        <tr>
                            ...
                            <th style="15%">UNIVERSITAS S1</th>
                            <th style="15%">PRODI S1</th>
                            <th style="15%">TAHUN MASUK S1</th>
                            <th style="15%">RIWAYAT KERJA SEBELUM S2</th>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-sebelum-kuliah")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
    ...
    $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	$.ajax({
            url: "{{url('graph-sebelum-kuliah')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            success:function(response){
                console.log(response);
                Highcharts.chart('chart_riwayat', {
                    chart: {
                        type: 'pie'
                    },
                    title: {
                        text: 'Pendidikan dan Pekerjaan Sebelum Kuliah - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                    },
                    subtitle: {
