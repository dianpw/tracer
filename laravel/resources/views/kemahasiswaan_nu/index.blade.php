            ...
            <div class="tab-pane active show" id="m_tabs_1_3" role="tabpanel">
                <div class="row">
                    ...
                    <div class="col-md-3 text-right">
                        <a href="{{url('export_kemahasiswaan_nu')}}" class="btn btn-success m-btn m-btn--custom m-btn--icon">
                            <span>
...
<script>
    ...
    $(document).ready(function(){
        var table_evaluasi_pegawai = $('.tabel_show').DataTable({
            ...
            ajax: {
                url: '{{url("datatable-kemahasiswaan-nu")}}',
                dataSrc: 'result',
            },
            scrollX:        true,
            autoWidth:         true,
    ...
    $('.filter-checkbox').on('change', function(e){
     ...
     $('#change_graph').select2({width: 'resolve'});
        ...
        function chart(tahun){
        	 $.ajax({
            url: "{{url('graph-kemahasiswaan-nu')}}" + '/' + tahun,
            type: 'GET',
            dataType: 'JSON',
            ...
            Highcharts.chart('organisasi_kemahasiswaan', {
                ...
                title: {
                    text: 'Kemahasiswaan NU - Tahun lulus: '+'<b style="color:#1978a9">' +tahun+'</b><br><br>'
                },
                subtitle: {
